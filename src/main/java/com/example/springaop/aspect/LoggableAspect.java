...
public class LoggableAspect {
    ...
    @Pointcut("within(@com.example.springaop.aspect.Loggable *)")
    public void classLoggable() {}

    @Pointcut("@annotation(com.example.springaop.aspect.Loggable)")
    public void methodsLoggable() {}

    @Around("methodsLoggable() || classLoggable()")
